        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label for="category_id" class="control-label">Tricycle Type</label>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="Tricycle_name" class="control-label">Tricycle Name</label>
                    <input type="text" name="Tricycle_name" id="Tricycle_name" class="form-control form-control-sm rounded-0" required>
                </div>
                <div class="form-group">
                    <label for="Tricycle_registration_number" class="control-label">Tricycle Registration Number</label>
                    <input type="text" name="Tricycle_registration_number" id="Tricycle_registration_number" class="form-control form-control-sm rounded-0" required>
                </div>
                <div class="form-group">
                    <label for="Tricycle_model" class="control-label">Tricycle Model</label>
                    <input type="text" name="Tricycle_model" id="Tricycle_model" class="form-control form-control-sm rounded-0" required>
                </div>
                <div class="form-group">
